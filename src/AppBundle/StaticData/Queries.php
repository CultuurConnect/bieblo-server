    ...
    static public function getTags() {
        return [
            ...
            3 => [
                ...
                '(subject:geheimen)',
                '(subject:misdaad)',
                '(subject:”gijzelingen en ontvoeringen”)',
                '(subject:detectives)',
            ],
            4 => [
                '(genre:sportverhalen)',
            ...
            5 => [
                ...
                '(subject:katten)',
                '(subject:paarden)',
                '(subject:dierenbescherming)',
                '(subject:dierenartsen)',
                '(subject:boerderijen)',
                '(subject:huisdieren)',
            ],
            6 => [
                '(subject:”andere culteren”)',
                '(subject:vluchtelingen)',
                '(subject:volken)',
                '(subject:indianen)',
                '(subject:”multiculturele samenleving”)',
            ],
            7 => [
